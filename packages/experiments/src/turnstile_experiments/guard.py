...
# the replay backends; "context_strategy", "prefix_caching", and
# "tool_batching" (and, as Section A lands, its remaining siblings) by the
# re-pricing runner -- each only once its transform exists.
