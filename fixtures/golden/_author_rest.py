...
def inflate_turns(n, start_cursor, index_offset=0):
    ...
    for j in range(n):
        i = j + index_offset
        turn_start = cursor
        l, cursor = stack(cursor, llm, span_id=f"l{i}", model="openai/gpt-5-mini",
...
l0, cursor = stack(0, llm, span_id="l0", model="openai/gpt-5", kind="route",
...
l0, cursor = stack(cursor, llm, span_id="l0", model="openai/gpt-5-mini", kind="route",
...
turn1_start = cursor
l1, cursor = stack(cursor, llm, span_id="l1", model="openai/gpt-5-mini", kind="slot_fill",
...
l2, cursor = stack(cursor, llm, span_id="l2", model="openai/gpt-5-mini", kind="compose",
...
cursor = 0
turn0_start = cursor
l0, cursor = stack(cursor, llm, span_id="l0", model="openai/gpt-5-mini", kind="slot_fill",
...
l0, cursor = stack(0, llm, span_id="l0", model="openai/gpt-5-mini", kind="compose",
...
l0, cursor = stack(cursor, llm, span_id="l0", model="openai/gpt-5-mini", kind="compose",
...
tool1, cursor = stack(cursor, tool, span_id="tool1", name="update_address",
                       args_hash="sha256:dupAddr1", kind="mutation",
                       result_hash="sha256:updok1", effect="committed")
l1, cursor = stack(cursor, llm, span_id="l1", model="openai/gpt-5-mini", kind="compose",
...
turn1_start = cursor
l1, cursor = stack(cursor, llm, span_id="l1", model="openai/gpt-5", kind="compose",
...
tool3, cursor = stack(cursor, tool, span_id="tool3", name="update_address",
                       args_hash="sha256:dupAddr9", kind="mutation",
                       result_hash="sha256:updok9", effect="committed")
l3, cursor = stack(cursor, llm, span_id="l3", model="openai/gpt-5-mini", kind="compose",
                    chosen="confirm_update_retry", candidates=["confirm_update_retry"],
                    out_text="Trying that update again.", in_tok=520, out_tok=15)
...
turn2_start = cursor
l2, cursor = stack(cursor, llm, span_id="l2", model="openai/gpt-5-mini", kind="slot_fill",
                    chosen="order_number", candidates=["order_number"],
...
for i in range(3):
    turn_start = cursor
    l, cursor = stack(cursor, llm, span_id=f"l{i}", model="openai/gpt-5-mini", kind="compose",
...
l3, cursor = stack(cursor, llm, span_id="l3", model="openai/gpt-5-mini",
...
l0, cursor = stack(0, llm, span_id="l0", model="openai/gpt-5-mini", kind="slot_fill",
                    chosen="order_number", candidates=["order_number"],
...
for i in range(40):
    ...
    l, c2 = stack(turn_start, llm, span_id=f"l{i}", model="openai/gpt-5-mini",
                  kind="compose", chosen=f"step_{i}", candidates=[f"step_{i}"],
